...
LESSON = LessonSpec(
    ...
    architecture_svg='''<svg viewBox="0 0 760 240" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Crossplane v2: XRD + Composition + Functions + Providers + ConfigurationPackage.">
  <rect x="10" y="10" width="740" height="220" rx="12" fill="#FBF7F0" stroke="#7F5A2A"/>
  <text x="380" y="32" text-anchor="middle" font-size="13" font-weight="700" fill="#3F4A5E" letter-spacing="1">CROSSPLANE V2 · PLATFORM-AS-API</text>
  <rect x="20" y="50" width="170" height="65" rx="6" fill="#3F4A5E"/>
  <text x="105" y="70" text-anchor="middle" font-size="10" font-weight="700" fill="#FBF1D6">XRD</text>
  <text x="105" y="86" text-anchor="middle" font-size="8" fill="#FBE8DC" font-style="italic">user-facing CRD schema</text>
  <text x="105" y="100" text-anchor="middle" font-size="8" fill="#FBE8DC">+ Claim type (namespaced)</text>
  <line x1="190" y1="82" x2="220" y2="82" stroke="#5A4F45" stroke-width="2" marker-end="url(#aP3)"/>
  <defs><marker id="aP3" markerWidth="10" markerHeight="10" refX="8" refY="5" orient="auto"><polygon points="0 0, 10 5, 0 10" fill="#5A4F45"/></marker></defs>
  <rect x="220" y="50" width="170" height="65" rx="6" fill="#5DCAA5"/>
  <text x="305" y="70" text-anchor="middle" font-size="10" font-weight="700" fill="#1F2433">Composition + Functions</text>
  <text x="305" y="86" text-anchor="middle" font-size="8" fill="#1F2433" font-style="italic">KCL / Pkl / Go templating</text>
  <text x="305" y="100" text-anchor="middle" font-size="8" fill="#1F2433">/ patch-and-transform</text>
  <line x1="390" y1="82" x2="420" y2="82" stroke="#5A4F45" stroke-width="2" marker-end="url(#aP3)"/>
  <rect x="420" y="50" width="170" height="65" rx="6" fill="#5A6B81"/>
  <text x="505" y="70" text-anchor="middle" font-size="10" font-weight="700" fill="#FBF1D6">Providers</text>
  <text x="505" y="86" text-anchor="middle" font-size="8" fill="#FBE8DC" font-style="italic">provider-upjet-aws / azure / gcp</text>
  <text x="505" y="100" text-anchor="middle" font-size="8" fill="#FBE8DC">SaaS providers (Vault / GitHub)</text>
  <line x1="590" y1="82" x2="620" y2="82" stroke="#5A4F45" stroke-width="2" marker-end="url(#aP3)"/>
  <rect x="620" y="50" width="120" height="65" rx="6" fill="#FF9900"/>
  <text x="680" y="70" text-anchor="middle" font-size="10" font-weight="700" fill="#1F2433">Cloud / SaaS</text>
  <text x="680" y="86" text-anchor="middle" font-size="8" fill="#1F2433" font-style="italic">RDS · GCS bucket</text>
  <text x="680" y="100" text-anchor="middle" font-size="8" fill="#1F2433">Vault namespace · etc.</text>
  <rect x="20" y="130" width="350" height="55" rx="6" fill="#A04832"/>
  <text x="195" y="150" text-anchor="middle" font-size="10" font-weight="700" fill="#FBF1D6">Tenant submits Claim</text>
  <text x="195" y="166" text-anchor="middle" font-size="8" fill="#FBE8DC" font-style="italic">apiVersion: db.example.com/v1</text>
  <text x="195" y="178" text-anchor="middle" font-size="8" fill="#FBE8DC">kind: PostgresInstance · spec: { size, engine, ... }</text>
  <rect x="380" y="130" width="360" height="55" rx="6" fill="#5E4A8E"/>
  <text x="560" y="150" text-anchor="middle" font-size="10" font-weight="700" fill="#FBF1D6">ConfigurationPackage</text>
  <text x="560" y="166" text-anchor="middle" font-size="8" fill="#FBE8DC" font-style="italic">OCI artifact bundling XRDs + Compositions + Function refs</text>
  <text x="560" y="178" text-anchor="middle" font-size="8" fill="#FBE8DC">distribute platform shape across clusters</text>
  <rect x="20" y="195" width="720" height="30" rx="6" fill="#FBE8DC" stroke="#A04832"/>
  <text x="380" y="215" text-anchor="middle" font-size="10" font-weight="700" fill="#A04832">Continuous reconciliation: drift auto-corrected · ProviderConfig auth via IRSA / Workload Identity</text>
</svg>''',
    architecture_caption='Crossplane v2 platform-as-API: XRD declares user-facing API + Claim type → Composition + Functions render → Providers reconcile with cloud/SaaS. Tenants submit Claims; Crossplane drives the cloud. ConfigurationPackage = OCI bundle distributing platform shape across clusters.',
)
